  ...
  return (
    <div className="w-screen min-h-screen bg-gradient-to-r from-blue-100 to-yellow-100 flex flex-col items-center">
      ...
      <div className="max-w-4xl mt-8 p-6 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-lg text-gray-700 mb-4">
          At DocsBuddy, we are driven by the widespread frustration and confusion many face when trying to understand their health insurance policies. Even the most diligent individuals struggle with dense, jargon-filled documents and a lack of clear, accessible information. Recognizing this critical need, we set out to transform complicated texts into understandable insights.
        </p>
        <p className="text-lg text-gray-700 mb-4">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Stories of people feeling overwhelmed by their policies inspired us to create DocsBuddy, a reliable 24/7 companion that simplifies health insurance for everyone. We are committed to ensuring no one navigates the complexities of health insurance alone. You deserve to make informed, confident decisions about your healthcare, and DocsBuddy is here to demystify the process.
        </p>
      </div>
    </div>
  );
